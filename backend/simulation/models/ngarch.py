...
def _simulate_ngarch_paths(
    ...
    Innovations are pre-generated by the caller in ``z_noise`` to guarantee
    reproducibility under ``parallel=True``.
    """
    dt = t / n_steps
    sqrt_dt = np.sqrt(dt)
...
def _simulate_ngarch_terminal(
    ...
    """
    Numba kernel for terminal-only NGARCH simulation. Innovations pre-generated.
    """
    dt = t / n_steps
    sqrt_dt = np.sqrt(dt)
...
if __name__ == "__main__":
    ...
    sigma0, omega, alpha, beta, gamma = 0.20, 0.002, 0.05, 0.90, 0.5
